<section class="flex fixed top-0 flex-col  border-xl border-black h-screen font-[Montserrat] shadow-xl bg-[#F6F8FA] justify-between ">
    <div>
        ...
        <a class="flex w-[236px] py-3 items-center mx-[32px] hover:shadow hover:drop-shadow-2xl hover:rounded-lg" href="/duan1/admin/category">
            <img class="ml-[20px]" src="../assets/images/cate.svg" alt="">
            <span class="text-base ml-[15px]">Danh mục</span>
        </a>
        <a class="flex w-[236px] py-3 items-center mx-[32px] hover:shadow hover:drop-shadow-2xl hover:rounded-lg" href="/duan1/admin/adminorder">
    ...
    <div class="mb-8">
        <!-- profile -->
        <a href="/duan1/" class="border border-red-700 mx-[32px] py-1 inline-block px-auto rounded text-center w-[240px]">
            <span class="text-red-700 ">Về trang chủ</span>
        </a>
    </div>
</section>
