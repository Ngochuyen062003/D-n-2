                ...
                <div class="shadow-default rounded-lg p-4">
                    ...
                    <div class="py-4 flex flex-wrap">
                        <div class="w-full md:w-1/2 md:pr-3 mt-4 md:mt-0">
                            ...
                            <input name="first_name" class="appearance-none block w-full font-medium rounded-lg py-3 px-4 outline-[#808080] outline-1 outline-double focus:outline-primary focus:outline-2 duration-150 placeholder:text-[#808080]" type="text">
                        </div>
                        <div class="w-full md:w-1/2 md:pl-3 mt-4 md:mt-0">
                            <p class="text-sm mb-2">Tên</p>
                            <input name="last_name" class="appearance-none block w-full font-medium rounded-lg py-3 px-4 outline-[#808080] outline-1 outline-double focus:outline-primary focus:outline-2 duration-150 placeholder:text-[#808080]" type="text">
                        </div>
                        <div class="w-full mt-4">
                            <p class="text-sm mb-2">Địa chỉ email</p>
                            <input name="email" class="appearance-none block w-full font-medium rounded-lg py-3 px-4 outline-[#808080] outline-1 outline-double focus:outline-primary focus:outline-2 duration-150 placeholder:text-[#808080]" type="email" >
                        </div>
                    </div>
                    <div class="py-4 flex flex-wrap">
                        <div class="w-full md:mb-4">
                            <p class="text-sm mb-2">Địa chỉ</p>
                            <input name="address" class="appearance-none block w-full font-medium rounded-lg py-3 px-4 outline-[#808080] outline-1 outline-double focus:outline-primary focus:outline-2 duration-150 placeholder:text-[#808080]" type="text" >
                        </div>
                        <div class="w-full mt-4 md:mt-0">
                            <p class="text-sm mb-2">Tỉnh / Thành phố</p>
                            <input name="city" class="appearance-none block w-full font-medium rounded-lg py-3 px-4 outline-[#808080] outline-1 outline-double focus:outline-primary focus:outline-2 duration-150 placeholder:text-[#808080]" type="text">
                        </div>
                    </div>
                    <div class="py-4">
